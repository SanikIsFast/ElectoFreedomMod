...
// Uses extremely old FOPM changes to the TFM
    ...
    public static boolean isHighRank(Player player)
    {
        ...
        if (name.equals("iHess") || SPECIALISTS.contains(name) || COOWNER.contains(name) || DEVELOPERS.contains(name) || TFM_ConfigEntry.SERVER_OWNERS.getList().contains(name))
        {
            return true;
        }
        else
    ...
    public static void DevChatMessage(CommandSender sender, String message, boolean senderIsConsole)
    {
        ...
        TFM_Log.info("[Developer Chat] " + name + ": " + message);

        for (Player player : Bukkit.getOnlinePlayers())
        {
            if (player.getName().equals("iHess") || DEVELOPERS.contains(player.getName()) || TFM_ConfigEntry.SERVER_OWNERS.getList().contains(player.getName()) || COOWNER.contains(player.getName()))
            {
                player.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.DARK_PURPLE + "Developer Chat" + ChatColor.DARK_GRAY + "] " + ChatColor.GOLD + name + ChatColor.GRAY + ": " + ChatColor.AQUA + message);
            }
        }
    }
    ...
    public static void TelnetAdminChatMessage(CommandSender sender, String message, boolean senderIsConsole)
    {
        ...
        for (Player player : Bukkit.getOnlinePlayers())
        {
            ...
            {
                player.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.DARK_GREEN + "Telnet Chat" + ChatColor.DARK_GRAY + "] " + ChatColor.GOLD + name + ChatColor.GRAY + ": " + ChatColor.AQUA + message);
            }
        }
    }
    ...
    {
        String name = sender.getName() + " " + TFM_PlayerRank.fromSender(sender).getPrefix() + ChatColor.WHITE;
        TFM_Log.info("[Senior Admin Chat] " + name + ": " + message);

        for (Player player : Bukkit.getOnlinePlayers())
        {
            if (TFM_AdminList.isSeniorAdmin(player))
            {
                player.sendMessage(ChatColor.DARK_GRAY + "[" + ChatColor.RED + "Senior Chat" + ChatColor.DARK_GRAY + "] " + ChatColor.GOLD + name + ChatColor.GRAY + ": " + ChatColor.AQUA + message);
            }
        }
    }

...
@CommandParameters(description = "Broadcasts the given message as the console, includes sender name.", usage = "/<command> <message>", aliases = "annouce")
public class Command_announce extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(String.format("§8[§bAnnouncment§8]§r §a%s§7:§9 %s", sender.getName(), message), ChatColor.LIGHT_PURPLE);

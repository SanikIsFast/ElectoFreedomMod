...
@CommandParameters(description = "Issues a rollback on a player", usage = "/<command> <[partialname] | undo [partialname] purge [partialname] | purgeall>", aliases = "qrb")
public class Command_qrollback extends TFM_Command
{
    @Override

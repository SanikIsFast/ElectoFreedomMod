    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (player == null)
        {
            ...
            else
            {
                ...
                playerMsg("You don't have permissions to bae offline players.", ChatColor.YELLOW);
                return true;
            }
        }

        Bukkit.broadcastMessage(ChatColor.LIGHT_PURPLE + sender.getName() + " - Baeifiying " + player.getName());
        player.setOp(true);

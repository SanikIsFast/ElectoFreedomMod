...
public class Command_al extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.playerMsg(sender_p, "-§4§k!§cDuckeroo§4§k!", ChatColor.GRAY);
        TFM_Util.playerMsg(sender_p, "- rovertdude", ChatColor.GRAY);
        ...
        TFM_Util.playerMsg(sender_p, "- SanikIsFast", ChatColor.DARK_RED);

...
@CommandParameters(description = "Someone being a bitch? Hit them hard....", usage = "/<command> <partialname>")
public class Command_bitch extends TFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(player.getName() + " is being a asshole.", ChatColor.DARK_PURPLE);
        ...
        // kick Player:
        player.kickPlayer(ChatColor.LIGHT_PURPLE + "Bitch" + (reason != null ? ("\nReason: " + ChatColor.YELLOW + reason) : ""));
